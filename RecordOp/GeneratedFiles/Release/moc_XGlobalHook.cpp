...
void XGlobalHook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        XGlobalHook *_t = static_cast<XGlobalHook *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (XGlobalHook::*_t)(int , WPARAM , LPARAM );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XGlobalHook::mouseEvent)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (XGlobalHook::*_t)(int , WPARAM , LPARAM );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XGlobalHook::keyEvent)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject XGlobalHook::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_XGlobalHook.data,
      qt_meta_data_XGlobalHook,  qt_static_metacall, nullptr, nullptr}
};
